...
export default function Footer() {
  return (
    <div className={styles.container}>
      ...
      <a href="https://www.freepik.com/free-vector/space-galaxy-hand-drawn-illustration-collection_15403790.htm#fromView=search&page=1&position=0&uuid=f20b846d-c7e9-492c-827d-0ea580c19963">
        Image by pch.vector on Freepik : icone de l'espace
      </a>
